...
export const preciousMetals: PreciousMetals = {
  howToTradePreciousMetals: '如何交易貴金屬',
  forThoseTraders:
    '對於那些有興趣維持交易平衡的交易者，貴金屬交易是他們投資組合中重要的一部分，因為貴金屬被視為能預防通貨膨脹的保值資產。在WCG，貴金屬以美元報價。',
  ...
  participantsInGoldTrading: '黃金交易的參與者',
  ...
  reasonsAffectingThePriceOfGold: '影響金價的原因',
  thereAreManyFactors: '影響金價的因素非常多。以下是影響因素的簡單概述',
  centralBank: '央行',
  theseInstitutions:
  ...
  stockMarket: '股市',
  whenTheStockMarket: '股市下跌時，交易者往往轉向買進黃金，因而助推黃金價格。',
  historicalGoldPrice: '歷史金價',
  theFollowingTable:
