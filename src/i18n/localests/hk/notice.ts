...
export const notice: Notice = {
  ...
  whenTheCustomerWithdrawsMoney:
    '當客戶取款時，我們會審核客戶上次取款（首次取款則從開戶開始）至本次取款的所有交易，按照交易量統計，當交易單中有50% 交易量的持倉時間低於5分鐘時，我們就會對此賬戶進行進一步審核，審核時間需要延長3小時。',
  ...
  whenEconomicData:
    '當經濟數據或重要新聞事件发布的時候，價格可能由於市場對新聞、數據作出的反應和調整而跳空。在這樣的情況下，市場狀況可能會非常不穩定，價格可能單方向劇烈變動，且在某些情況下，市場可能在短期內無法提供可用的交易。在周末或節假日後重新開盤的時候也往往會发生市場跳空的情況。止盈和止損單在市場跳空時可能以相距指定價格甚遠的價位來執行，這種偏差可能對交易者有利，也可能對交易者不利。止盈和止損單可能在提交定單或定單設置的價格以外的位置執行。定單可能會分批在不同的價位執行。開盤價可能與前一日收盤價可能有很大的差別。',
  leverageAndMarginPolicy: '槓桿與保證金政策',
  inAnyCase:
    '在任何情況下，交易者都需要有足夠保證金維持開倉頭寸，WCG不提供追加保證金的通知，如周末及假期前，保證金水平不足所需保證金100%時，WCG有權因應市場波動或根據當時的需要，按個別情況將客戶的所有倉位進行鎖倉(對沖)處理。',
  setTheValidityPeriodOfTheOrder: '訂單設置有效期',
  allPendingOrders:
    '所有掛單及止損獲利設置的有效期為1周，在周末休市前，所有未建倉的掛單及未執行的止損或獲利設置將全部取消。如有需要，客戶可在周一開市後重新設置。'
};
