...
export const indexTrading: IndexTrading = {
  ...
  theBasisOfTradingIndexes: 'Dasar*indeks*perdagangan',
  indexesAllowUs:
  ...
  marketValueWeightedIndex: 'Indeks*tertimbang*nilai*pasar',
  ...
  priceWeightedIndex: 'Indeks*harga*tertimbang',
  thisTypeOfIndex:
  ...
  theWorldsNineMajorIndexes: 'Sembilan*indeks*utama*dunia',
  ...
  SPX500: 'Indeks*S&P*500*AS*(SPX500)',
  ...
  UK100: 'Indeks*FTSE*100*Inggris*(UK100)',
  ...
  ESTX50: 'Indeks*Stoxx*50*Eropa*(ESTX50)',
  itIsComposedOf50:
  ...
  howToTradeIndex: 'Bagaimana*cara*memperdagangkan*indeks',
  ...
  identifyTradingOpportunities: 'Identifikasi*peluang*perdagangan',
  ...
  correlationBetween: 'Korelasi*antara*Indeks*DAX*Jerman*dan*Indeks*S&P*500*AS',
  ...
  theDifferenceBetween: 'Perbedaan*antara*DAX*Jerman*dan*S&P*500',
  inOrderToEvaluate:
  ...
  typeOfCompanies: 'Jenis*perusahaan',
  theUnitedStatesHas:
