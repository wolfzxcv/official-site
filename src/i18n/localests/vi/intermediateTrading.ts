...
export const intermediateTrading: IntermediateTrading = {
  understandChartPatterns: 'Hiểu*các*mẫu*biểu*đồ',
  makeYourTradingMore:
  ...
  howToCreateATradingStrategy: 'Làm*thế*nào*để*tạo*một*chiến*lược*giao*dịch?',
  commonChartPatterns: 'Các*mẫu*biểu*đồ*phổ*biến',
  stopLossAndTakeProfit: 'Cắt*lỗ*và*chốt*lời',
  exampleOfStopLoss: 'Ví*dụ*về*Cắt*lỗ:',
  chartAnalysis: 'Phân*tích*biểu*đồ',
  sellingPrice: 'Giá*bán,*giá*mua*và*chênh*lệch',
  personalizationOfTheChart: 'Cá*nhân*hóa*biểu*đồ',
  ...
  hidingTheSellingPriceLine: 'Ẩn*dòng*giá*bán',
  ...
  setDefaultChart: 'Đặt*biểu*đồ*mặc*định',
  ...
  usingShortcutKeys: 'Sử*dụng*các*phím*tắt',
  ...
  navigate: 'Điều*hướng',
  controlN: 'Control+N',
  toAddIndicators: 'Để*thêm*các*chỉ*số,*EA*và*chức*năng*đăng*nhập.',
  marketQuotation: 'Báo*giá*thị*trường',
  controlM: 'Control+M',
  viewProductQuotation: 'Xem*báo*giá*sản*phẩm.',
  dataWindow: 'Cửa*sổ*dữ*liệu',
  controlD: 'Control+D',
  ...
  openTheNavigationWindow: 'Mở*cửa*sổ*điều*hướng*(Ctrl*+*N);',
  ...
  moveTheMouseCursor: 'Bấm*chuột*phải*vào*con*chuột;',
  rightClickTheMouse: 'Bấm*chuột*phải*vào*con*chuột;',
  selectAddToFavorites: 'Chọn*"Thêm*vào*Yêu*thích".',
  alerts: 'Cảnh*báo',
  ...
  payAttentionToTheRisk: 'Chú*ý*đến*rủi*ro*của*mỗi*giao*dịch',
  beforePlacingATrade:
  ...
  transactionVolume: 'Khối*lượng*giao*dịch*=*100.000',
  yiPip00001: '1*pip*=*0,*0001',
  aUDUSDexchangeRate: 'Tỷ*giá*hối*đoái*AUD*/*USD*=*0,*7465',
  pipValue0000107465: 'Giá*trị*Pip*=*0,*0001*/*0,*7465***100,*000*=*AUD*13,*39',
  ...
  assessYourSkills: 'Đánh*giá*kỹ*năng*của*bạn',
  ...
  psychologicalPreparation: 'Chuẩn*bị*tâm*lý',
  ...
  risksManagement: 'Quản*lý*rủi*ro',
  whenYouAreTrading:
  ...
  prepareToTrade: 'Chuẩn*bị*giao*dịch',
  beforeYouOYourFirst:
  ...
  positionOpeningAndClosing: 'Quy*tắc*mở*và*đóng*vị*trí',
  ...
  recordAllMatters: 'Ghi*lại*tất*cả*các*vấn*đề:',
  ...
  yourInitialStopLoss: 'mức*dừng*lỗ*và*mức*lợi*nhuận*ban*đầu*của*bạn;',
  positionSize: 'quy*mô*vị*trí;',
  reasonForOpeningAPosition: 'lý*do*để*mở*một*vị*thế;',
  psychologyDuringThe: 'tâm*lý*trong*quá*trình*giao*dịch;',
  whetherItIsProfitOrLoss: 'cho*dù*đó*là*lãi*hay*lỗ;',
  ...
  whatIsAChartPattern: 'Mô*hình*giá*là*gì？',
  ...
  headAndShoulders: 'Mô*hình:*Đầu*-*Vai',
  ...
  howMuchStopLoss: 'Đặt*mức*dừng*lỗ*bao*nhiêu?',
  ...
  pendingOrder: 'Danh*sách*các*lệnh*chờ*xử*lý',
  aPendingOrder:
  ...
  typesOfPendingOrders: 'Các*loại*lệnh*đang*chờ*xử*lý',
  stopLossPending:
  ...
  stopLossEntryOrder: 'Lệnh*dừng*lỗ',
  theFollowingFigure:
  ...
  takeProfitPendingOrder: 'Lệnh*chờ*Chốt*lời',
  theFigureBelowShows:
  ...
  priceComposition: 'Tiêu*chuẩn*giá',
  onTheCandlestick:
  ...
  highestPrice: '-Giá*cao*nhất:*giá*cao*nhất*xảy*ra*trong*kỳ.',
  lowestPrice: '-Giá*thấp*nhất:*giá*thấp*nhất*xảy*ra*trong*kỳ.',
  closingPriceThe:
  ...
  buyOrderLongPosition: 'Lệnh*mua*(vị*thế*mua)',
  quotation: 'Báo*giá:*1.36298*/*1.36301',
  theOpeningPriceForBuying: 'Giá*mở*cửa*để*mua*là*1.36301',
  sellOrderShortPosition: 'Lệnh*bán*(vị*thế*bán)',
  theOpeningPriceForSelling: 'Giá*mở*bán*là*1.36298',
  inBothCases:
