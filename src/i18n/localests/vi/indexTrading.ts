...
export const indexTrading: IndexTrading = {
  ...
  theBasisOfTradingIndexes: 'Cơ sở của chỉ số giao dịch',
  indexesAllowUs:
    'Các chỉ số cho phép chúng tôi nghiên cứu hoạt động của các khu vực thị trường để xác định tốt hơn các cơ hội đầu tư và biến động thị trường. Vì chỉ số theo dõi nhiều cổ phiếu được giao dịch công khai, các nhà giao dịch có thể theo dõi chỉ số để hiểu những thay đổi chung trên thị trường và xây dựng chiến lược đầu tư tương ứng. Các phương pháp tính giá mà nó sử dụng có thể được chia thành hai loại.',
  marketValueWeightedIndex: 'Chỉ số gia quyền giá trị thị trường',
  ...
  priceWeightedIndex: 'Chỉ số trọng giá',
  thisTypeOfIndex:
  ...
  theWorldsNineMajorIndexes: 'Chín chỉ số chính của thế giới',
  ...
  SPX500: 'Chỉ số S&P 500 của Hoa Kỳ (SPX500)',
  ...
  US30: 'Chỉ số Dow Jones của Hoa Kỳ (US30)',
  ...
  UK100: 'Chỉ số FTSE 100 của Vương quốc Anh (UK100)',
  ...
  GER30: 'Chỉ số DAX của Đức (GER30)',
  thisIndexConsistsOf:
  ...
  AUS200: 'Chỉ số ASX 200 của Úc (AUS200)',
  ...
  FRA40: 'Chỉ số CAC 40 của Pháp (FRA40)',
  theBenchmarkIndex:
  ...
  ESTX50: 'Chỉ số Stoxx 50 của Châu Âu (ESTX50)',
  itIsComposedOf50:
  ...
  howToTradeIndex: 'Cách giao dịch chỉ số',
  ...
  identifyTradingOpportunities: 'Xác định cơ hội giao dịch',
  ...
  correlationBetween:
    'Mối tương quan giữa Chỉ số DAX của Đức và Chỉ số S&P 500 của Hoa Kỳ',
  ...
  theDifferenceBetween: 'Sự khác biệt giữa DAX của Đức và S&P 500',
  inOrderToEvaluate:
  ...
  typeOfCompanies: 'Loại hình công ty',
  theUnitedStatesHas:
  ...
  tradingIndexContract: 'Hợp đồng chỉ số giao dịch',
