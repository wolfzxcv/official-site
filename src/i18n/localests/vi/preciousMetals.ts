...
export const preciousMetals: PreciousMetals = {
  howToTradePreciousMetals: 'Cách*giao*dịch*kim*loại*quý',
  forThoseTraders:
  ...
  diversifiedInvestment: 'Đầu*tư*đa*dạng',
  ...
  fightAgainstInflation: 'Chống*lạm*phát',
  ...
  highStorageValue: 'Giá*trị*lưu*trữ*cao',
  ...
  participantsInGoldTrading: 'Người*tham*gia*kinh*doanh*vàng',
  ...
  largeInstitutions: 'Các*tổ*chức*lớn',
  ...
  reasonsAffectingThePriceOfGold: 'Lý*do*ảnh*hưởng*đến*giá*vàng',
  thereAreManyFactors:
  ...
  goldTradingExample: 'Ví*dụ*kinh*doanh*vàng',
  practicalGoldTrading: 'Kinh*doanh*vàng*thực*tế',
  ...
  profitScenario: 'Kịch*bản*lợi*nhuận',
