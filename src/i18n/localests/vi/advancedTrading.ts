...
export const advancedTrading: AdvancedTrading = {
  analysisAndTrends: 'Phân*tích*và*xu*hướng',
  ...
  technicalAnalysis: 'Phân*tích*kỹ*thuật*và*xu*hướng*thị*trường',
  fundamentalAnalysis: 'Phân*tích*cơ*bản',
  fibonacciRetracementLine: 'Fibonacci*Retraceme',
  supportAndResistance: 'Hỗ*trợ*và*kháng*cự',
  marketParticipants: 'Tham*gia*thị*trường',
  tradingStyle: 'Phong*cách*giao*dịch',
  whatIsTechnical: 'Phân*tích*kỹ*thuật*là*gì?',
  ...
  theMarketPrice: 'Giá*thị*trường*chứa*tất*cả*thông*tin*mà*mọi*người*cần*hiểu;',
  thePriceFluctuates: 'Giá*dao*động*xung*quanh*một*đường*xu*hướng;',
  historyWillRepeat: 'Lịch*sử*sẽ*tự*lặp*lại.*',
  theseThreePremises:
  ...
  aSupportLine:
    '->*Đường*hỗ*trợ*đề*cập*đến*một*đường*được*kết*nối*bởi*một*loạt*các*giá*hỗ*trợ.*Nếu*tỷ*giá*hối*đoái*đã*từng*giảm*xuống*mức*giá*này*và*quay*đầu*nhiều*lần*thì*chúng*ta*coi*đó*là*giá*có*đường*hỗ*trợ.*Càng*nhiều*lần*giá*chạm*và*quay*trở*lại*từ*đường*này,*hỗ*trợ*càng*đáng*tin*cậy.*',
  theResistanceLine:
  ...
  fundamentalAnalysisOverview: 'Tổng*quan*về*phân*tích*cơ*bản',
  ...
  exchangeRate: 'Phân*tích*dài*hạn*về*các*nguyên*tắc*cơ*bản',
  forExample:
  ...
  balanceOfPayments: 'Lý*thuyết*cán*cân*thanh*toán',
  accordingToThe:
  ...
  applicationExample: 'Ví*dụ*ứng*dụng',
  ifYouFind:
  ...
  previousHigh: 'Cao*/*thấp*trước*đó',
  whenTheFX:
  ...
  technicalIndexJudgment: 'Đánh*giá*chỉ*số*kỹ*thuật',
  ...
  interbankMarket: 'Thị*trường*liên*ngân*hàng',
  theInterbankMarket:
  ...
  retailTraders: 'Thương*nhân*bán*lẻ',
  ...
  nonBank: 'Công*ty*ngoại*hối*phi*ngân*hàng',
  refersToForeign:
  ...
  fundamentals: 'Nguyên*tắc*cơ*bản*(giao*dịch*vĩ*mô)',
  ...
  longTermTrading: 'Giao*dịch*dài*hạn',
  theTradingStyle:
  ...
  swingTrading: 'Giao*dịch*xoay*vòng',
  asASwing:
  ...
  technicalTrading: 'Giao*dịch*kỹ*thuật',
  ...
  trendTrading: 'Giao*dịch*theo*xu*hướng',
  theTrendTrading:
