...
export const platform: Platform = {
  efficientAndFreeTrading:
    '高效自由的交易體驗由強大公平的交易平台開始，直觀且方便易用，支援各種訂單類型，圖表下單一鍵交易',
  personalTradingIndicators: '個人交易指標',
  MT4ProvidesSimpleAndEasyToUse:
    'MT4提供簡單易用的工具，按照您的交易風格來制訂個人專屬交易指標，並且可透過專屬的指標程式庫、腳本至Expert Advisors輕鬆實現交易。',
  advancedChartTools: '先進圖表工具',
  MT4Provides31Chart:
    'MT4提供31種圖表分析工具和30種不同的交易指標，可設定每個指標和圖表類別，建立適合您的參數及顯示方式，讓您獲得滿意的交易體驗。',
  diversifiedInvestmentTransactions: '分散投資交易',
  theBestWayToManageRisk:
    '管理風險的最佳方式就是分散投資。在WCG的MT4交易平台中，您可以從一系列的交易產品及市場中作出選擇，從而強化及分散您的投資。',
  intuitiveAndEasyToUse: '直觀且方便易用',
  completeAndComprehensiveReports:
    '完善的綜合報表，例如跟蹤號碼，開盤價，交易量，所有訂單的帳戶狀態和持倉的綜合信息，都能在程序端窗口提供。並且可以隨時隨地查看即時市場資訊，輔助您作出理性的交易決策，更完整的支援智慧交易（EA）和策略回測系統，為您提供高度的交易靈活性、監督以及控制。',
  ...
  MT4ProvidesAMoreComprehensive:
    '提供了更全面的分析機會。每個交易品種都可以顯示九種時間週期，可以使交易者看到詳細的價格動態。 結合這些工具，確定行情趨勢，強大的分析能力幫您更徹底的分析市場動向，把握最佳時刻。',
  ...
  balanceIsAllocatedAccordingToProportion: '結餘依比例配置',
  allocationByProfitAndLoss: '按盈虧分配',
  profitAndLoss: '盈虧按百分比分配',
  profitAndLossAre: '盈虧按結餘百分比分配',
  investment200: '投資$200',
  profit120: '利潤$120',
  investment300: '投資$300',
  profit180: '利潤$180',
  investment500: '投資$500',
  profit300: '利潤$300',
  ...
  toProvideYouWithFlexibleAndCompetitiveRates:
    '為您提供有彈性又有競爭力的費率，設定快速以及高水準的持續支援，MAM系統也提供所有您需要的資料清單，包括未結束交易、餘額、盈虧、客戶聯絡資料等。',
  transparentCommissionDetails: '傭金明細一目了然',
  realTimeDisplay:
    '即時顯示主帳戶及子帳戶明細，包括獲利、佣金、隔夜利息、餘額以及保證金水平。',
  convenientAndFastExecution: '交易執行方便快捷',
  allTransactionOrders:
    '所有交易單均透過主帳戶執行，其後再依照您所選擇的配置方式轉移到子帳戶。 結合這些工具，確定行情趨勢，強大的分析能力幫您更徹底的分析市場動向，把握最佳時刻。',
  AMustHaveSystem: '專職經紀必備系統',
  multilingualTradingPlatform:
    '多語言交易平台與行銷素材，流通性佳、執行可靠，可開立無限個帳戶，讓您成為一個專業的經紀人。'
};
