...
export const crudeOil: CrudeOil = {
  ...
  howToTradeCommodities: 'Bagaimana*memperdagangkan*komoditas',
  ...
  basicKnowledgeOfCrudeOil: 'Pengetahuan*dasar*tentang*minyak*mentah',
  ...
  typesOfCrudeOilTransactions: 'Jenis*transaksi*minyak*mentah',
  likeStocks:
  ...
  extractionAndRefining: 'Ekstraksi*dan*pemurnian',
  crudeOilExtractionAndRefining:
    'Proses*ekstraksi*dan*pemurnian*minyak*mentah*mahal.*Karena*cadangan*minyak*berada*jauh*di*bawah*tanah,*mengekstraksi*minyak*mentah*dari*bawah*tanah*membutuhkan*harga*yang*relatif*besar.',
  anyTechnologicalProgress:
    'Kemajuan*atau*kemunduran*teknologi*dalam*proses*penambangan*berdampak*langsung*pada*harga*minyak*mentah.',
  consumptionAndDemand: 'Konsumsi*dan*Permintaan',
  theLargestConsumer:
    'Konsumen*dan*permintaan*minyak*mentah*terbesar*adalah*Amerika*Serikat,*diikuti*oleh*Jepang,*China,*dan*negara*industri*Eropa*seperti*Jerman*dan*Inggris.',
  theIndustrialAndEconomicSectors:
    'Sektor*industri*dan*ekonomi*negara-negara*ini*memiliki*permintaan*minyak*mentah*yang*besar.*Sebab,*permintaan*mereka*akan*mempengaruhi*harga*minyak*mentah*dunia.',
  availabilityAndSupply: 'Ketersediaan*dan*pasokan',
  ...
  naturalDisastersAndAccidents: 'Bencana*alam*dan*kecelakaan',
  naturalDisastersSuchAs:
    'Bencana*alam*seperti*gempa*bumi*dan*angin*topan*merupakan*kejadian*yang*tidak*dapat*diprediksi.*Kerugian*lokasi*pengeboran*dan*kilang*yang*disebabkan*oleh*bencana*ini*dapat*menghambat*dan*menunda*produksi*minyak*mentah.',
  firesAndMechanicalFailures:
    'Kebakaran*dan*kerusakan*mekanis*juga*dapat*menyebabkan*keterlambatan*produksi*karena*perlunya*waktu*pemulihan.*Keterlambatan*yang*disebabkan*oleh*faktor*lingkungan*tersebut*akan*menurunkan*pasokan*minyak*mentah*sehingga*mengakibatkan*kenaikan*harga.',
  youNeedToBeFamiliarWith:
    'Anda*perlu*memahami*dan*secara*teratur*meninjau*dua*laporan*minyak*mentah',
  USDepartmentOfEnergy: 'Laporan*persediaan*minyak*mentah*Departemen*Energi*AS',
  ...
  OPEC: 'Laporan*Pasar*Minyak*Mentah*OPEC',
