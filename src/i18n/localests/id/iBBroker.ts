...
export const iBBroker: IBBroker = {
  ...
  withAVarietyOfAgency:
    'Dengan*berbagai*pengaturan*khusus*agensi,*keuntungan*yang*diperoleh*dapat*tumbuh*dengan*level*yang*berbeda.',
  aVarietyOfCommission: 'Berbagai*opsi*pengaturan*komisi',
  theRebateCanBeSet:
    'Rebate*dapat*diatur*sesuai*dengan*pelanggan*dan*volume*transaksi*yang*berbeda,*secara*efektif*menangani*kebutuhan*distribusi.',
  flexibleFundsSettlement: 'Penyelesaian*Dana*Fleksibel',
  receiveCommissions:
    'Dapatkan*komisi*sesuai*dengan*metode*pembayaran*yang*Anda*pilih,*dan*transfer*ke*rekening*yang*Anda*tunjuk*sesegera*mungkin.',
  transparentAndClear: 'Struktur*lembaga*yang*transparan*dan*jelas',
  highlyTransparentAgency:
    'Sistem*agensi*yang*sangat*transparan,*semua*item*pengaturan*sekilas*terlihat*jelas.',
