...
export const conditions: Conditions = {
  ...
  theVerificationProcedures:
    "The*verification*procedures*for*executing*customer*instructions*or*responding*to*customer-related*inquiries,*daily*administration*of*accounts,*or*direct*or*indirect*marketing*of*related*investment*products*or*services,*share*with*WenChuan's*affiliated*or*related*companies*on*related*investment*or*transaction*services,*Repeatedly*verify*and*transfer*such*personal*data",
  dealWithCustomers:
  ...
  WenChuanWillKeep:
    'WenChuan*will*keep*the*client’s*personal*information*confidential,*but*may*provide*it*to*the*following*organizations/persons*based*on*actual*conditions*and*needs:',
  WenChuanOtherCompanies:
    'WenChuan*other*companies*include*wholly-owned*or*partially-owned*companies*in*the*name*of*wholly-owned*subsidiaries*or*affiliated*companies*of*subsidiaries*or*directors*and*employees*of*the*group;',
  ...
  anyRegulatoryOrGovernmentAgency:
    'Any*regulatory*or*government*agency*that*is*related*to*or*supervises*any*business*of*WenChuan;',
  ...
  AccordingTo:
    'According*to*the*terms*of*the*regulations,*customers*have*the*right*to*request*that*any*false*data*about*customers*be*corrected*by*WenChuan*and*to*request*in*writing*that*we*terminate*the*use*of*their*personal*data*for*direct*or*indirect*marketing*purposes.*WeiWenChuan*reserves*the*right*to*charge*a*reasonable*fee*for*processing*requests*for*data*or*corrections*made*in*accordance*with*the*provisions*of*the*regulations.',
  ...
  theCopyrightsOfThisWebsiteAndAllText:
    'The*copyrights*of*this*website*and*all*text,*graphics,*images,*software*and*other*materials*on*this*website*belong*to*WenChuan*International*or*its*licensors.',
  ...
  exceptAsExpresslyStipulatedInThisAgreement:
    'Except*as*expressly*stipulated*in*this*agreement,*without*the*prior*written*permission*of*WenChuan*International,*you*may*not*change,*modify,*copy,*distribute*or*commercially*use*any*information*on*this*website.',
  forTheAboveMentionedPurposes:
    'For*the*above-mentioned*purposes,*you*can*copy*the*above-mentioned*trademarks*as*they*are*from*the*materials*downloaded*from*this*website.*WenChuan*International*may*at*any*time*notify*you*of*changes*to*this*agreement*by*posting*the*latest*version*of*this*agreement*on*this*website.*You*are*responsible*for*reviewing*this*agreement*frequently.*By*using*this*website*after*the*above-mentioned*changes*are*posted,*you*agree*to*the*above-mentioned*changes.',
  entireAgreement: 'Entire*Agreement',
  thisAgreementContains:
    'This*agreement*contains*the*entire*agreement*between*you*and*WenChuan*International*regarding*your*access*to*and*use*of*this*website.*WenChuan*International*may*at*any*time*notify*you*of*changes*to*this*agreement*by*posting*the*latest*version*of*this*agreement*on*this*website.*You*are*responsible*for*reviewing*this*agreement*frequently.*By*using*this*website*after*the*above-mentioned*changes*are*posted,*you*agree*to*the*above-mentioned*changes.',
  thirdPartyInformation: 'Third-party*information*and*website',
  thisWebsiteMayContain:
    "This*website*may*contain*materials*produced*by*third*parties*or*links*to*other*websites.*The*above-mentioned*materials*and*websites*are*provided*by*third-party*vendors*and*are*not*under*the*direct*control*of*WenChuan*International.*WenChuan*International*assumes*no*responsibility*or*responsibility*for*the*operation*or*content*of*any*of*the*above-mentioned*third-party*materials*or*other*websites*(whether*or*not*linked*to*this*website).*obligation.*You*confirm*that*if*you*set*up*any*links*between*other*websites*and*this*website*without*WenChuan*International's*prior*written*consent,*WenChuan*International*reserves*the*right*to*request*you*to*delete*it.",
  responsibilitiesOfWenChuanInternational:
    'Responsibilities*of*WenChuan*International',
  whenYouRegisterAs:
    "When*you*register*as*a*WenChuan*International*customer*and*accept*WenChuan*International's*services,*you*must*accept*the*WenChuan*International*business*terms.*Business*terms*apply*to*your*relationship*with*WenChuan*International*and*WenChuan*International's*responsibilities*to*you*for*the*services*it*provides.*Although*WenChuan*International*regularly*updates*the*website,*it*does*not*guarantee*that*the*information*or*data*contained*in*the*website*reflects*the*latest*situation*or*is*accurate,*or*that*the*products*or*services*listed*on*the*website*are*currently*valid.*WenChuan*International*may*change*the*information*posted*on*this*website*at*any*time*without*notice.",
  ...
  youSufferAnyIndirect:
    'You*suffer*any*indirect,*special,*incidental*or*consequential*damages*due*to*use,*delay*in*use*or*inability*to*access*this*website,*or*for*any*other*reasons*related*to*this*website,*including*but*not*limited*to*downloading*any*software*from*this*website,*including*but*not*Limited*to*damage*to*your*computer*or*computer*system*or*settings,*loss*of*data,*loss*of*income*or*profit,*WenChuan*International*does*not*assume*any*responsibility*for*you.*WenChuan*International*does*not*represent*or*guarantee*that*the*website*or*information*meets*your*requirements*or*that*the*website*or*any*software*will*be*uninterrupted,*safe*or*free*of*any*errors*or*viruses.',
  yourInformation: 'Your*information',
  inAdditionToYourObligation:
    'In*addition*to*your*obligation*to*register*as*a*customer*of*WenChuan*International,*you*agree*to*ensure*that*all*information*you*provide*to*WenChuan*International*is*complete*and*accurate*to*the*extent*you*know*and*believe.*You*agree*to*notify*WenChuan*International*immediately*of*any*changes*in*the*information*you*provide,*so*that*WenChuan*International*can*update*records*in*a*timely*manner*and*accurately*reflect*the*latest*situation.',
  companyInformation: 'Company*Information',
  WenChuanInternational: 'WenChuan*International*Co.,*Ltd.',
  ...
  ifYouNeedAnyAssistance: 'If*you*need*any*assistance,*please*call',
  orEmailUs: 'or*email*us*your*comments*directly*at',
