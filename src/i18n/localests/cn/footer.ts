...
export const footer: Footer = {
  ...
  WCGMarketsLtdIsALimitedLiabilityCompany:
    'WCG Group Ltd 是位于圣文森特和格林纳丁斯群岛St.Vincent依据国际商业公司法注册的有限责任公司，公司编号为26087 BC 2020。注册地址是： The Financial Services Centre Stoney Ground, Kingstown, St.Vincent & the Grenadines.',
  WCGMarketsLtdIsRegulatedByTheFINTRAC:
    'WCG Group Ltd 获加拿大金融情报部门(FIU)加拿大金融交易和报告分析中心(FINTRAC)监管，MSB牌照编号为 M20282836。注册地址是： 150-10451 Shellbridge Way, Richmond BC V6X 2W8, Canada.',
  WCGGlobalLtd:
  ...
  restrictedAreas:
    '受限制地区：WCG Group Ltd 的网站信息不针对加拿大的卑诗省、魁北克省和萨斯喀彻温省地区、日本、朝鲜、伊朗、美国以及香港的居民；并且不向身处与发布或使用该信息有违当地法律法规的国家或管辖地之人发送或供其使用。'
};
