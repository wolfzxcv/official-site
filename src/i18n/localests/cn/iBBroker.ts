...
export const iBBroker: IBBroker = {
  ...
  introducingBrokers: '介绍代理人',
  ourUniqueIBPlanPays:
    '我们独特的IB计划向各种规模的代理人支付佣金，为您提供一个更佳的佣金制度，通过不断介绍交易者产生交易佣金，为您带来源源不绝的利润！同时还能通过代理后台随时查看客户的交易报告以及各项数据。',
  fullyCompetitive: '竞争力十足',
  customizeACommission:
    '为您量身定做适合您的佣金结构，当每次客户通过专属介绍代理人开立交易账户时，新客户就会自动归属到合作伙伴名下。您也能通过返还条款和特定时期内的交易数量来确定并培养你的明星客户。',
  boostYourIBPerformance: '提升您的IB业绩',
  asTheAgentOfWCG:
  ...
  accordingToTheTransaction:
    '根据您所推荐客户的交易量，您将实时得到极具竞争力的返利。',
  multiLevelAgencySettings: '多层级的代理设定',
  withAVarietyOfAgency: '拥有多种代理专属设定，获得的利润可随不同级别而增长。',
  aVarietyOfCommission: '多种佣金设定选项',
  theRebateCanBeSet: '可依照不同的客户及交易量设定返利，有效处理分配需求。',
  flexibleFundsSettlement: '弹性资金结算撷取',
  receiveCommissions: '按您选择的支付方法领取佣金，第一时间转入您的指定账户。',
  transparentAndClear: '代理构架透明清晰',
  highlyTransparentAgency: '高度透明的代理制度，所有设定项目一目了然。',
  viewCustomerProfile: '检视客户资料数据',
