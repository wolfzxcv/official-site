...
export const preciousMetals: PreciousMetals = {
  howToTradePreciousMetals: '如何交易贵金属',
  forThoseTraders:
    '对于那些有兴趣维持交易平衡的交易者，贵金属交易是他们投资组合中重要的一部分，因为贵金属被视为能预防通货膨胀的保值资产。在WCG，贵金属以美元报价。',
  ...
  participantsInGoldTrading: '黄金交易的参与者',
  ...
  reasonsAffectingThePriceOfGold: '影响金价的原因',
  thereAreManyFactors: '影响金价的因素非常多。以下是影响因素的简单概述',
  centralBank: '央行',
  theseInstitutions:
  ...
  stockMarket: '股市',
  whenTheStockMarket: '股市下跌时，交易者往往转向买进黄金，因而助推黄金价格。',
  historicalGoldPrice: '历史金价',
  theFollowingTable:
