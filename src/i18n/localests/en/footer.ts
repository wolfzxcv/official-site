...
export const footer: Footer = {
  ...
  WCGMarketsLtdIsALimitedLiabilityCompany:
    'WCG Group Ltd is a limited liability company registered under the International Business Company Law in Saint Vincent and the Grenadines. The company number is 26087 BC 2020. The registered address is: The Financial Services Centre Stoney Ground, Kingstown, St.Vincent & the Grenadines.',
  WCGMarketsLtdIsRegulatedByTheFINTRAC:
    'WCG Group Ltd is regulated by the FINTRAC. The MSB license number is M20282836. The registered address is: 150-10451 Shellbridge Way, Richmond BC V6X 2W8, Canada.',
  WCGGlobalLtd:
  ...
  restrictedAreas:
    "Restricted areas: WCG Group Ltd's website information does not aimed at targeting residents of British Columbia, Quebec and Saskatchewan, the Democratic People's Republic of Korea (North Korea), Iran, the United States and Hong Kong; And not to send or use the information to people in countries or jurisdictions where the publication or use of this information violates local laws and regulations."
};
