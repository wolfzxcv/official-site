...
export const basicTrading: BasicTrading = {
  ...
  afterOpening: 'After*opening*a*position,*sometimes*we*need*to*set*a*stop*loss/profit*for*the*position.*In*the*"Trade"*column*of*the*"Summary"*window*at*the*bottom*of*the*platform,*find*the*position*that*needs*to*be*modified,*right-click*on*it,*and*select*"Modify*or*Delete*Order"*from*the*menu.',
