...
export const contactUs: ContactUs = {
  ...
  AMoreHumanizedUserCenter:
    'يوفر مركز مستخدم أكثر إنسانية تم إنشاؤه باستخدام تقنية ذكاء اصطناعي جديدة التجربة النهائية للعملاء.',
  AwardedAsThe:
    'مُنحت على أنها شركة [أفضل تقنية وحلول مالية] من قبل وكالة التصنيف التنظيمي للتاجر المعروفة [Forex Forex WikiFX].',
  ObtainedThePreciousMetals:
    'الحصول على ترخيص [تسجيل تاجر المعادن الثمينة والأحجار الكريمة] من إدارة الجمارك في منطقة هونغ كونغ الإدارية الخاصة بجمهورية الصين الشعبية.'
};
