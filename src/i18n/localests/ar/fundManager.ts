...
export const fundManager: FundManager = {
  ...
  WCGProvidesAssetManagement:
    'تقوم*WCG*بتوفير*حلول*إدارة*الأصول*لمديري*الصناديق*الاستثمارية*،*بما*في*ذلك*أداة*إدارة*الأموال*MT4*MAM*(إدارة*الحسابات*المتعددة)*الحائزة*على*جوائز*لمساعدة*شركائنا*على*إدارة*أموال*العملاء*بفعالية*في*بيئة*آمنة*والنمو*جنبًا*إلى*جنب*معنا..',
  applyForManager: 'قدم*لتصبح*مدير*صندوق*استثماري****',
  youCanTrade:
    'يمكنك*التداول*في*السوق*من*خلال*أنظمة*حساب*مراكز*مختلفة.*توفر*WCG*أفضل*أدوات*التحليل*والتداول*(يدوية*وخوارزمية).*بالإضافة*إلى*ذلك،*سنواصل*تقديم*التحديثات*التلقائية*للبرامج*لتحقيق*التشغيل*السريع*والآمن*على*أي*جهاز..',
  makeFullUseOfAlgorithms:
    'قم*بالاستفادة*الكاملة*من*الخوارزميات*وفرص*التداول*لإنشاء*استراتيجياتك*واختبارها*وتحسينها.*حدد*كيفية*حساب*الوسائط*وتحديد*المواعيد*النهائية*وزيادة*رأس*المال*والقيمة*ومتطلبات*المستثمر*الأخرى.*إدارة*الحسابات*وإنشاء*تقارير*مفصلة*لمراقبة*نتائج*معاملات*العملاء*بطريقة*موحدة.*عرض*أي*بيانات*على*الرسم*البياني،*وحساب*وإدارة*أرصدة*التشغيل*والنفقات*ورسوم*المناولة*تلقائياً..',
  WCGCanHelpYourFund:
    'يمكن*لـ*WCG*مساعدة*صندوقك*على*زيادة*دخله:*سيتمكن*المتداولون*لديك*من*إدراك*إمكاناتهم*بالكامل*وتحقيق*أقصى*قدر*من*الأرباح*للصندوق،*وستجذب*نتائجها*الإيجابية*مستثمرين*جدد*للانضمام..',
  scientificAndFlexibleManagement: 'إدارة*علمية*ومرنة',
  overTheYears:
    'لقد*أقمنا*علاقة*ناجحة*مع*مديري*الصناديق*على*مر*السنين*لأننا*نتفهم*احتياجاتك',
  multiPersonAccountManagement: 'إدارة*حساب*متعدد*الأشخاص',
  usingTheWCGMAMManagementSystem:
    'يمكن*لمديري*الأموال*إدارة*حسابات*متعددة*بسرعة*عن*طريق*استخدام*نظام*إدارة*WCG*MAM',
  ...
  multipleTransactionAllocationTypes:
    'أنواع*متعددة*لتخصيص*المعاملات،*اعتمادًا*على*أسلوب*التداول*الخاص*بك*وحجم*وأنواع*أموال*العملاء.',
  multipleProductCategories: '*منتجات*متعددة*ذات*فئات*مختلفة*',
  multipleCurrencyProducts:
    'منتجات*العملات*المتعددة،*وأسعار*صرف*المراجحة،*والمعادن*الثمينة،*والسلع،*وعقود*فروقات*المؤشرات،*وغيرها',
  ...
  togetherWithWCG:
    'يمكنك*جنبًا*إلى*جنب*مع*WCG*استخدام*بيئة*التداول*الممتازة*لدينا*مع*مميزاتها*الكثيرة*للتعامل*مع*جميع*احتياجاتك*لإنشاء*مجموعة*واسعة*من*العملاء،*بغض*النظر*عن*حجم*عملك..',
