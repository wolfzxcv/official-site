...
export const advancedTrading: AdvancedTrading = {
  ...
  unlikeFundamentalAnalysis:
    'يقوم*التحليل*الفني*بالتركيز*بشكل*أساسي*فقط*على*الرسوم*البيانية*من*خلال*دراسة*التغيرات*في*الأسعار*التاريخية*للتنبؤ*بحركات*السوق*المستقبلية،*على*عكس*التحليل*الأساسي*الذي*يركز*على*التنمية*الاقتصادية*والسياسية*والمالية.',
  tradersWhoUse:
  ...
  aSupportLine:
    '->*يشير*خط*الدعم*إلى*خط*متصل*بسلسلة*من*الأسعار*الداعمة.*إذا*انخفض*سعر*الصرف*مرة*إلى*مستوى*السعر*هذا*وعاد*عدة*مرات،*فإننا*نعتبره*سعرا*ذو*خط*دعم.*كلما*لامس*السعر*هذا*الخط*وعاد*من*جديد،*كلما*كان*الدعم*أكثر*موثوقية.',
  theResistanceLine:
  ...
  forExample:
    'على*سبيل*المثال:*إن*سعر*علبة*الكولا*هو*1*دولار*أمريكي*في*الولايات*المتحدة*و*100*ين*في*اليابان.*وفقًا*لنظرية*تعادل*القوة*الشرائية،*فإن*سعر*الصرف*=*سعر*علبة*الكولا*في*الولايات*المتحدة*/*سعر*علبة*الكولا*في*اليابان*=*1:*100',
  ifTheCurrent:
