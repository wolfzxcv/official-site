...
export const regionalRepresentative: RegionalRepresentative = {
  ...
  youWillBe:
    'Anda*akan*menjadi*satu-satunya*wakil*di*kawasan*anda.*Melalui*program*perwakilan*serantau*WCG,*anda*akan*menikmati*hak*hak*eksklusif*di*kawasan*khusus*ini.',
  marketingAssistance: 'Sokongan*bantuan*pemasaran',
  provideComprehensive:
    'Berikan*sokongan*teknikal*yang*komprehensif*untuk*membantu*mengoptimumkan*promosi*rangkaian,bahan*pemasaran*dan*membantu*merekod*dan*mengurus*pelanggan*anda.',
  competitiveEdge: 'Daya*saing',
  weWillProvide:
    'Kami*akan*memberikan*syarat*perdagangan*yang*kompetitif*kepada*pelanggan*anda*dan*meningkatkan*kelebihan*perdagangan*anda*dengan*cepat*di*kawasan*anda.',
  regionalRepresentativeIsIncome: 'Pendapatan*wakil*daerah',
  yourIncomeIncludes:
    'Pendapatan*anda*merangkumi*komisen*standard*dari*setiap*transaksi*perujuk,serta*pendapatan*dari*semua*akaun*downline*anda*dan*imbuhan*agensi*tambahan',
  theSpecificAmount:
    'Jumlah*pendapatan*tambahan*tertentu*dapat*ditentukan*setelah*persetujuan*bersama*dengan*rakan*kongsi.',
  become: 'Jadi',
  yourOwnBoss: 'bos*anda*sendiri',
  become1: 'Menjadi',
  ourPartner: 'rakan*kongsi*kami',
  get: 'Dapatkan',
  technicalSupport: 'sokongan*teknikal',
  becomeOurRegional: 'Menjadi*wakil*wilayah*kami',
  wCGIsCurrently:
    'WCG*kini*sedang*mengalami*pengembangan*yang*pesat,*ia*bermaksud*bahawa*kami*akan*terus*mencari*dan*mengembangkan*pasaran*terbaru*dan*pelanggan*kami*akan*menjadi*sebahagian*daripada*model*perniagaan*kami*untuk*berkembang*bersama*kami.',
