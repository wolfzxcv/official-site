...
export const footer: Footer = {
  ...
  WCGMarketsLtdIsALimitedLiabilityCompany:
    'WCG Group Ltd adalah syarikat liabiliti terhad yang didaftarkan di bawah Undang-undang Syarikat Perniagaan Antarabangsa di Saint Vincent dan Grenadines. Nombor syarikat adalah 26087 SM 2020. Alamat berdaftar adalah: Pusat Perkhidmatan Kewangan Stoney Ground, Kingstown, St.Vincent & the Grenadines.',
  WCGMarketsLtdIsRegulatedByTheFINTRAC:
    'WCG Group Ltd dikawal selia oleh FINTRAC. Nombor lesen MSB adalah M20282836. Alamat berdaftar adalah: 150-10451 Shellbridge Way, Richmond BC V6X 2W8, Kanada.',
  WCGGlobalLtd:
