...
export const conditions: Conditions = {
  ...
  preciousMetalsTrading:
    'Perdagangan logam berharga melibatkan tahap risiko yang ketara dan tidak sesuai untuk semua orang. Sila rujuk kepada kontrak pelanggan untuk pengenalan terperinci tentang risiko. Tidak kira betapa mudah atau cekap perdagangan dalam talian, ini tidak mengurangkan risiko perdagangan logam berharga.',
