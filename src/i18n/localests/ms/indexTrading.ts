...
export const indexTrading: IndexTrading = {
  ...
  takeTheGermanDAX:
    'Ambil*indeks*DAX*Jerman*sebagai*contoh.*Anda*optimis*mengenai*prospek*ekonomi*Jerman,*jadi*anda*membeli*CFD*pada*indeks*DAX*dan*mengharapkan*syarikat-syarikat*Jerman*yang*relevan*menaikkan*harga*indeks.',
  itShouldBeNoted:
    'Perlu*diingatkan*bahawa*kenaikan*indeks*kadang-kadang*bukan*disebabkan*oleh*pertumbuhan*ekonomi*yang*sebenarnya,*melainkan*sentimen*risiko*pasaran*untuk*memegang*aset*berisiko*(seperti*saham).*Sudah*tentu,*penyimpangan*harga*yang*disebabkan*oleh*sentimen*risiko*tidak*akan*kekal*selama-lamanya,*dan*pembetulan*harga*mungkin*berlaku.*Pedagang*sering*membandingkan*prestasi*indeks*di*kawasan*yang*berbeza*untuk*mengenal*pasti*dan*menggunakan*peluang*perdagangan*yang*berpotensi.*Dengan*membandingkan*indeks*DAX*Jerman*dan*S&P*500*AS,*mari*kita*memahami*keadaan*sebenar.',
  correlationBetween: 'Hubungan*antara*Indeks*DAX*Jerman*dan*Indeks*S&P*500*AS',
  thePerformanceOfTheSP500:
    'Prestasi*S&P*500*bermaksud*kekuatan*syarikat*yang*diwakilinya,*dan*oleh*itu*dianggap*sebagai*petunjuk*baik*pasaran*saham*AS.*Sejajar*dengan*itu,*di*seberang*Atlantik,*indeks*DAX*mencerminkan*prestasi*pasaran*saham*Jerman.',
  theChartBelow:
    'Carta*di*bawah*menunjukkan*korelasi*kuat*antara*dua*indeks*utama*ini.*Apabila*trend*indeks*DAX*Jerman*dan*S&P*500*berbeza,*ia*sering*dianggap*sebagai*anomali*harga,*dan*peniaga*sering*menganggap*fenomena*ini*sebagai*peluang*perdagangan.',
  anIndexIsEitherBasedOn:
    'Indeks*sama*ada*berdasarkan*wilayah*atau*industri,*dan*merupakan*petunjuk*sentimen*pasaran*yang*sangat*baik.*Oleh*kerana*ekonomi*dari*berbagai*wilayah*sekarang*sangat*erat,*ada*korelasi*besar*antara*indeks*yang*berlainan.*Bagi*peniaga*yang*ingin*memperdagangkan*indeks,*sangat*penting*untuk*memahami*hubungan*antara*peristiwa*ekonomi*global*dan*corak*harga*indeks*utama.*Sebagai*contoh,*anda*mungkin*mengetahui*harga*semasa*dari*indeks*DAX*Jerman*dan*sama*ada*harga*pembukaan*mengalami*penurunan*atau*kenaikan.',
  theDifferenceBetween: 'Perbezaan*antara*DAX*Jerman*dan*S&P*500',
  inOrderToEvaluate:
    'Untuk*menilai*pergerakan*pasaran*seterusnya*dalam*keadaan*harga*yang*tidak*normal,*penting*untuk*memahami*ciri*unik*setiap*indeks*dan*kawasan*serta*industri*yang*diwakilinya.',
  typeOfCompanies: 'Jenis*syarikat',
  theUnitedStatesHas:
    'Amerika*Syarikat*mempunyai*ekonomi*yang*didorong*oleh*pengguna.*Hampir*50%*syarikat*dalam*S&P*500*adalah*syarikat*teknologi*maklumat,*kewangan,*dan*penjagaan*kesihatan*AS.*Sebaliknya,*ekonomi*Jerman*bergantung*pada*eksport,*dan*industri*teknologinya*agak*kecil.*Industri*kimia*Jerman*menyumbang*bahagian*terbesar*dari*indeks*DAX.',
  theDifferenceBetweenTotalReturnIndexAndPriceReturnIndex:
    'Perbezaan*antara*indeks*pulangan*total*dan*indeks*pulangan*harga',
  theTypicalFeature:
    'Ciri*khas*dari*keseluruhan*indeks*pulangan*adalah*bahawa*semua*dividen*digunakan*untuk*pelaburan*semula,*kerana*mengukur*kekuatan*syarikat*penyusunnya.*Indeks*DAX*Jerman*adalah*indeks*jumlah*pulangan*khas.*Sebaliknya,*S&P*500*adalah*indeks*pengembalian*harga,*yang*bermaksud*bahawa*dividen*tidak*termasuk*dalam*pengiraan*pulangan.*Oleh*itu,*indeks*DAX*cenderung*meningkat*lebih*tinggi*daripada*indeks*pulangan*bukan*total*seperti*S&P*500.',
  whenIndexPricesDiverge:
    'Apabila*harga*indeks*berbeza,*penting*untuk*mempertimbangkan*faktor-faktor*di*atas*sebelum*memutuskan*keputusan*perdagangan*anda*yang*seterusnya.*Indeks*perdagangan*melalui*CFD*adalah*kaedah*perdagangan*indeks*yang*paling*popular.*Produk*indeks*CFD*membolehkan*peniaga*mendapat*keuntungan*dari*kenaikan*atau*penurunan*harga.*Sekiranya*harganya*naik,*kedudukan*panjang*(beli)*anda*boleh*mendapat*keuntungan;*sekiranya*harganya*jatuh,*kedudukan*pendek*anda*(jual)*boleh*mendapat*keuntungan.',
  tradingIndexContract: 'Kontrak*Indeks*Perdagangan',
  aCommitmentToPurchase:
    'Komitmen*untuk*membeli*aset*tertentu*pada*harga*yang*ditentukan*pada*tarikh*yang*dipersetujui.',
