...
const MLXYHContent: React.FC<{}> = () => (
  <Flex bg={MLXYH_BG} color={MLXYH_FONT_WHITE} flexDir="column" align="center">
    <MLXYHTitle />
    <MLXYHForm />

    <Box mt="100px" fontSize={{ base: '14px', md: '22px' }}>
      您需达成下列交易手数即可以提取赠金
    </Box>
    <Box mb="50px" color={MLXYH_FONT_YELLOW}>
...
const MLXYHRules: React.FC<{}> = () => (
  <>
    ...
    <Box>2. 本次活动允许MT4账户的最大杠杆上限为1:200。</Box>
    <Box>
    ...
    <Box>
      6. Ifa customer withdraws funds during the event, they will be
    ...
    <Box>
      19. WCG reserves the righto modify, suspend, or terminate this promotion
      and any related rules at any time without prior notice to customers.
    </Box>
    <Box>20. 公司保留活動最終解釋權。</Box>
    <Box>
      20. The company reserves the right of final interpretation of the event.
    </Box>
  </>
);
  ...
  return (
    ...
    >
      <StyledSubmitForm>
        ...
        <Box width={{ base: '80%', md: '300px' }} mb={10}>
          <SubmitForm
            data={data}
            submit={'提交'}
