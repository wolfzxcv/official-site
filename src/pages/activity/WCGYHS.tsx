...
export const WCGYHSTitle: React.FC<{}> = () => (
  ...
  >
    ...
    <Box
      ...
      fontSize={{ base: '12px', md: '18px' }}
    >
      客户在活动期间存入2000美元或以上和贵金属、原油交易量达10手或外汇交易量达20手，即自动参加本活动，客户11月内首次存入任何金额的48小时内累计达要求，即可按层级拥有待领赠金。每手交易每逄周一结算返回5美元(信用额)直到完结待领赠金或整个活动完结，已发放的回赠会自动转变成现金可自由取出。
    </Box>
  </Flex>
);
...
const WCGYHSRules: React.FC<{}> = () => (
  <>
    ...
    <Box>
      10. 客户成功入金2000美元或以上和交易量达10手之后自动可参加是次活动。
    </Box>
    <Box>
      11. 贵金属，原油交易手数定义; 黄金
