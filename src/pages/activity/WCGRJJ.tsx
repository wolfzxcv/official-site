...
export const WCGRJJ_BG = '#ff9843';

const WCGRJJ_DATE_BG = '#cf502f';
const WCGRJJ_DATE_BORDER = '#e19e8a';
const WCGRJJ_BUTTON_BG = '#ff682f';
const WCGRJJ_FOOTER_BG = '#bb3a1d';

const WCGRJJ_TITLE_FONT = 'white';
    ...
    <>
      ...
      <Flex
        ...
        bgImage={{
          ...
          md: `/../assets/images/activity_WCGRJJ_${picLang}.jpg`
        }}
      ...
      {/* rules */}
      <Flex bg={WCGRJJ_FOOTER_BG} justify="center">
        <Stack
          my={'6em'}
...
const WCGRJJContent: React.FC<{}> = () => {
  const router = useRouter();
  const currentLang = router.locale as Locales;

  return (
    <Flex bg={WCGRJJ_BG} color="white" flexDir="column" align="center">
      <WCGRJJTitle />
...
export const WCGRJJTitle: React.FC<{}> = () => {
  const router = useRouter();
  const currentLang = router.locale as Locales;
  ...
  return (
    ...
    >
      <Box
        border="1px"
        borderColor={WCGRJJ_DATE_BORDER}
        borderRadius="20px"
        bg={WCGRJJ_DATE_BG}
        color={WCGRJJ_TITLE_FONT}
        py={2}
        mt={{ base: 0, md: 10 }}
        mb={10}
      ...
      <Box mt={20} fontSize={{ base: '14px', md: '22px' }} fontWeight={700}>
        {currentLang === 'zh'
