  ...
  return (
    <>
      ...
      <Flex
        ...
        bg={WCGSSJ_BG}
        bgImage={{
          base: '/../assets/images/activity_WCGSSJ15_M.jpg',
          md: '/../assets/images/activity_WCGSSJ15.jpg'
        }}
