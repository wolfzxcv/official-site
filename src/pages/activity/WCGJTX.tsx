...
export const WCGJTX_BG = '#e16331';

const WCGJTX_DATE_BG = '#e94d00';
const WCGJTX_DATE_BORDER = '#ec916f';
const WCGJTX_BUTTON_BG = '#276be8';
const WCGJTX_FOOTER_BG = '#12507f';

const WCGJTX_TITLE_FONT = 'white';

const WCGJTX_TABLE_FONT_YELLOW = '#f4e47a';
const WCGJTX_TABLE_BG_LEFT_TITLE = '#328aee';
const WCGJTX_TABLE_BG_RIGHT_TITLE = '#ee6200';
const WCGJTX_TABLE_BG_LEFT_CONTENT = '#276be8';
const WCGJTX_TABLE_BG_RIGHT_CONTENT = '#e94d00';
  ...
  return (
    <>
      ...
      <Flex
        ...
        bg={{ base: WCGJTX_BG, md: WCGJTX_BG }}
        bgImage={{
          base: '/../assets/images/activity_WCGJTX_M.jpg',
          md: '/../assets/images/activity_WCGJTX.jpg'
        }}
      ...
      {/* rules */}
      <Flex bg={WCGJTX_FOOTER_BG} justify="center">
        <Stack
          my={'6em'}
...
export const WCGJTXTitle: React.FC<{}> = () => (
  <Flex
    flexDir="column"
    p={2}
    pb={20}
  ...
  >
    <Box
      border="1px"
      borderColor={WCGJTX_DATE_BORDER}
      borderRadius="20px"
      bg={WCGJTX_DATE_BG}
      color={WCGJTX_TITLE_FONT}
      py={2}
      mt={{ base: 0, md: 10 }}
      mb={10}
      ...
      textAlign="center"
    >
      2024年10月01日至2024年10月31日
    </Box>
  </Flex>
);

const WCGJTXTable: React.FC<{}> = () => {
  const router = useRouter();
  const currentLang = router.locale as Locales;
...
const StyledWCGJTXTable = styled.table`
  width: 100%;
  table-layout: fixed;
  ...
  td,
  th {
    border: 1px solid ${WCGJTX_TITLE_FONT};
    padding: 10px;
    text-align: center;
    white-space: nowrap;
  }
  ...
  .table_left_title {
    color: ${WCGJTX_TABLE_FONT_YELLOW};
    background-color: ${WCGJTX_TABLE_BG_LEFT_TITLE};
  }

  .table_right_title {
    background-color: ${WCGJTX_TABLE_BG_RIGHT_TITLE};
  }

  tbody > tr > td {
    background-color: ${WCGJTX_TABLE_BG_RIGHT_CONTENT};
    &:first-child {
      color: ${WCGJTX_TABLE_FONT_YELLOW};
      background-color: ${WCGJTX_TABLE_BG_LEFT_CONTENT};
    }
  }
`;

const WCGJTXRules: React.FC<{}> = () => {
  const router = useRouter();
  const currentLang = router.locale as Locales;
