...
export const WCGKJ_BG_RED = '#530b0f';
const WCGKJ_BG_BROWN = '#500410';
const WCGKJ_FT_RED = '#650717';
const WCGKJ_FONT_YELLOW = '#fcd35f';
const WCGKJ_BUTTON = '#a60000';
...
const WCGKJ: React.FC<{}> = () => {
  return (
    <>
      ...
      {/* rules */}
      <Flex fontSize="8px" bg={WCGKJ_FT_RED} justify="center">
        <Stack
          my={10}
          width="90vw"
          color={'white'}
