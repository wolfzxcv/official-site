...
export const WCGKJ_BG_BROWN = '#500410';

const WCGKJ_TITLE_FONT = '#530b0f';

const WCGKJ_FOOTER_BG = '#650717';
const WCGKJ_FONT_YELLOW = '#fcd35f';

const WCGKJ_BTN_RED = '#a60000';
    ...
    <>
      ...
      <Flex
        ...
        bgImage={{
          ...
          md: '/../assets/images/activity_WCGKJ.jpg'
        }}
      ...
      {/* rules */}
      <Flex bg={WCGKJ_FOOTER_BG} justify="center">
        <Stack
          my={10}
...
const WCGKJContent: React.FC<{}> = () => (
  <Flex bg={WCGKJ_BG_BROWN} color="white" flexDir="column" align="center">
    <WCGKJTitle />
    ...
    <Stack width="90vw" maxW="1000px" py={10} textAlign="center">
      <Text>
        例子:酷极客户首次入金6,000美元，48小时内再入金4,000美元即达10000美元。每手交易可回赠3美元，在活动结算前完成了100手，活动二总共获得300美元回赠，加上活动一获取赠金50美元，酷极客户尊享额外回赠共350美元。另加上本身[WCG超级优惠不止双11]活动中每手回赠5美元，可获取的500美元，酷极客户在11月共取得850美元可自由取出。
      </Text>
    </Stack>
...
export const WCGKJTitle: React.FC<{}> = () => (
  <Flex
    flexDir="column"
    p={2}
    my={5}
  ...
  >
    ...
    <Box
      borderRadius="25px"
      bg={WCGKJ_FONT_YELLOW}
      color={WCGKJ_TITLE_FONT}
      fontWeight={600}
      my={10}
      px={5}
      py={3}
...
const StyledWCGKJTable = styled.table`
  width: 100%;
  ...
  thead {
    ...
    background-color: ${WCGKJ_FOOTER_BG};
  }
...
const WCGKJRules: React.FC<{}> = () => (
  <>
    ...
    <Box>
      1.
      酷极客户在活动期间完成所属的入金交易手数要求(转移帐户后开仓计算的已平仓单)，即可获得回赠。
    </Box>
    <Box>2. 回赠于交易后逄周一发放。</Box>
    <Box>3. 酷极客户在活动期间内申请提取资金将取消此活动资格。</Box>
    <Box>4. 每位酷极客户只可使用一个账号参加此活动一次。</Box>
