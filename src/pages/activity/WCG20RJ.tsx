...
export const WCG20RJ_BG = '#205e45';

const WCG20RJ_DATE_BG = '#1c8cce';
const WCG20RJ_DATE_BORDER = '#82a799';
const WCG20RJ_BUTTON_BG = '#ea402f';
const WCG20RJ_FOOTER_BG = '#1a483b';

const WCG20RJ_TITLE_FONT = 'white';
    ...
    <>
      ...
      <Flex
        ...
        bgImage={{
          ...
          md: `/../assets/images/activity_WCG20RJ.jpg`
        }}
      ...
      {/* rules */}
      <Flex bg={WCG20RJ_FOOTER_BG} justify="center">
        <Stack
          my={'6em'}
...
const WCG20RJContent: React.FC<{}> = () => {
  const router = useRouter();
  const currentLang = router.locale as Locales;

  return (
    <Flex bg={WCG20RJ_BG} color="white" flexDir="column" align="center">
      <WCG20RJTitle />
...
export const WCG20RJTitle: React.FC<{}> = () => {
  const router = useRouter();
  const currentLang = router.locale as Locales;
  ...
  return (
    ...
    >
      <Box
        border="1px"
        borderColor={WCG20RJ_DATE_BORDER}
        borderRadius="20px"
        bg={WCG20RJ_DATE_BG}
        color={WCG20RJ_TITLE_FONT}
        py={2}
        mt={{ base: 0, md: 10 }}
        mb={10}
